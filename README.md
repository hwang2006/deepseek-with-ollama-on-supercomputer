...
Once deepseek-r1 is successfully pulled, it will be shown in the 'Select Model' dropdown menu on the top right. You can start chatting with the deepseek-r1:14b model. You could also pull and chat with other models (e.g., llama3, mistral, etc) from the Ollama models site. 
